...
public class SetUsingArraysWithIterator<T> implements SetInterface<T>{
...
//            throw new AccessingAnEmptyADTCheckedException();
    ...
    class SeparateClassInnerIterator implements Iterator<T>{
        ...
        SetUsingArraysWithIterator<T> aSet;
        SeparateClassInnerIterator(SetUsingArraysWithIterator<T> aSet){
            this.aSet = aSet;
        }
    ...
    public static <T> SetUsingArraysWithIterator union(SetUsingArraysWithIterator<T> aSet, SetUsingArraysWithIterator<T> anotherSet) throws AddingIntoFullADTCheckedException , AccessingAnEmptyADTCheckedException{
        SetUsingArraysWithIterator<T> result = new SetUsingArraysWithIterator<T>();
    ...
    public static <T> SetUsingArraysWithIterator difference(SetUsingArraysWithIterator<T> aSet, SetUsingArraysWithIterator<T> anotherSet) throws AddingIntoFullADTCheckedException , AccessingAnEmptyADTCheckedException{
        SetUsingArraysWithIterator<T> result = new SetUsingArraysWithIterator<T>();
        T [] aSet_array = aSet.toArray();
        for (int i = 0; i < aSet_array.length; i++){
    ...
    public static <T> SetUsingArraysWithIterator intersection(SetUsingArraysWithIterator<T> aSet, SetUsingArraysWithIterator<T> anotherSet) throws AddingIntoFullADTCheckedException, AccessingAnEmptyADTCheckedException {
        SetUsingArraysWithIterator<T> result = new SetUsingArraysWithIterator<T>();
    ...
    public static void main(String[] args) {
        try{
            SetInterface<Integer> aSet = new SetUsingArraysWithIterator<Integer>();
            aSet.add(3);
            aSet.add(1);
            aSet.add(2);
